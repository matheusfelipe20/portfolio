...
import giomelo from '../../../assets/img/project/giomelo.png'
...
const Projects = () => {
  ...
  const projectsData = [
    ...
    { id: 4, tag: texts.TagFreelancer_Project, title: 'Giomelo Programmer', description: texts.DescriptionProject_Giomelo_Project, color: 'var(--color-tag-freelancer)', imgSrc: giomelo, link: 'https://giomelo.github.io/portifolio/', tag_technology: ['React', 'JavaScript'],},
    { id: 5, tag: texts.TagProfile_Project, title: 'Meu Portfolio', description: texts.DescriptionProject_MeuPortfolio_Project, color: 'var(--color-tag-profile)', imgSrc: portfolio, link: 'https://github.com/matheusfelipe20/portfolio', tag_technology: ['React', 'JavaScript'],},
    { id: 6, tag: texts.TagProject_Project, title: 'Proj. DSC - UFPB', description: texts.DescriptionProject_DscUFPB_Project, color: 'var(--color-tag-project)', imgSrc: meajude, link: 'https://github.com/matheusfelipe20/Projeto-Final-DSC', tag_technology: ['Java', 'Spring Boot'],},
    ...
    { id: 9, tag: texts.TagTraining_Project, title: 'Proj. Asp.net', description: texts.DescriptionProject_AspNet_Project, color: 'var(--color-tag-training)', imgSrc: aspnet, link: 'https://github.com/matheusfelipe20/Projeto-ASP.NET', tag_technology: ['C#', 'ASP.Net', 'HTML/CSS'],},
    { id: 10, tag: texts.TagProject_Project, title: 'Sist. Apostas Esportivas', description: texts.DescriptionProject_ApostasEsportivas_Project, color: 'var(--color-tag-project)', imgSrc: apostasEsportivas, link: 'https://github.com/matheusfelipe20/desafio-api-jogos', tag_technology: ['Golang', 'JavaScript'],},
  ];
