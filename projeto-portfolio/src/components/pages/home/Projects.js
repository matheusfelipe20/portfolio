...
const projectsData = [
  ...
  { id: 5, tag: 'Estudo', title: 'Chat Socket TCP', color: 'var(--color-tag-study)', imgSrc: chatSocketTCP, link: 'https://github.com/matheusfelipe20/ChatSocketTCP', tag_technology: ['Java'],},
  { id: 6, tag: 'Jogo', title: 'Jogo Nave Simples', color: 'var(--color-tag-game)', imgSrc: jogoNave, link: 'https://github.com/matheusfelipe20/Jogo-Nave-simples-JAVA', tag_technology: ['Java'],},
  { id: 7, tag: 'Treino', title: 'Proj. Asp.net', color: 'var(--color-tag-training)', imgSrc: aspnet, link: 'https://github.com/matheusfelipe20/Projeto-ASP.NET', tag_technology: ['C#', 'ASP.Net', 'HTML/CSS'],},
];
